...
void main() {
  ...
  group('createUser', () {
    ...
    test(
        'Should call the [ApiFailure] and complete sucessfully when the call to the remote source is successful',
        () async {
      //Arange
    ...
    test(
        'Shoul return a [ServerFailure] when the call to the remote source is unsiccessful',
        () async {
      when(() => remoteDataSource.createUser(
          createdAt: any(named: 'createdAt'),
          name: any(named: 'name'),
  ...
  group('getUsers', () {
    test(
        'Should call the [RemoteDataSource.getUsers] and return [List<User>] when call to remote source is succesful',
        () async {
